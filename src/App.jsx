          ...
          {isLoading && (
            <div className="absolute inset-0 z-10 flex items-center justify-center bg-white/50 backdrop-blur-sm rounded-3xl min-h-[400px]">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="font-bold text-violet-800">กำลังซิงค์ข้อมูล...</p>
              </div>
            </div>
          )}
    ...
    <div className="max-w-6xl mx-auto space-y-6 md:space-y-8">
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
        <div className="bg-gradient-to-br from-emerald-50 to-white p-4 md:p-6 border-b border-emerald-100 flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base md:text-xl font-black text-emerald-900 tracking-tight">สรุปจำนวนชิ้นสินค้าที่สูญหาย (Database)</h3>
          </div>
        </div>
          ...
          <table className="w-full text-left min-w-full">
            ...
            <tbody className="divide-y divide-slate-50">
              ...
              {branchSummaries.length === 0 && (
                <tr>
                  <td colSpan={4} className="p-8 md:p-10 text-center font-bold text-slate-400 text-sm md:text-base">ไม่พบรายการสูญหายในช่วงวันที่/สาขา ที่เลือก</td>
                </tr>
              )}
            </tbody>
            <tfoot>
